# 1 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino"
/////////////////////////////////
//       Projet ECLIPSE        //
// Ecrit par Maxime MAUCOURANT //
// MMAUCOURANT AT FREE DOT FR  //
/////////////////////////////////
# 7 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 8 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 9 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 10 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 11 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 12 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 13 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 14 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 15 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 16 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2



# 20 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 21 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 2
# 36 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino"
...
{
  // Eteint la lumière
  digitalWrite(13 /* Revoir l'affectation de la pin*/, 0x0);

  // On fait clignoter 3 fois la lumière
  for (int i = 0; i < count; i++)
  {
    delay(wait);
    digitalWrite(13 /* Revoir l'affectation de la pin*/, 0x1);
    delay(wait);
    digitalWrite(13 /* Revoir l'affectation de la pin*/, 0x0);
  }
}
...
void handleJSLib()
{
  server.send(200, "text/plain", (reinterpret_cast<const __FlashStringHelper *>(JS_lib)));
}
...
void handleConfig()
{
  ...
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_HEAD_START));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_STYLE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_SCRIPT));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_HEAD_END));
  page += (reinterpret_cast<const __FlashStringHelper *>(CONFIG_PAGE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_END));
...
void handleRoot()
{
  ...
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_STYLE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_HEAD_END));
  page += (reinterpret_cast<const __FlashStringHelper *>(MAIN_PAGE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_END));
...
void handleUpdate()
{
  ...
  // Construction des éléments du DOM
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_HEAD_START));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_REFRESH));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_STYLE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_HEAD_END));
  ...
  {
    page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_UPDATE_START));
  ...
  {
    page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_UPDATE_RESULT));
...
void handleSystem()
{
  ...
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_SCRIPT));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_HEAD_END));
  page += (reinterpret_cast<const __FlashStringHelper *>(SYSTEM_PAGE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_END));
...
void handleSystemSave()
{
  ...
  {
    page += (reinterpret_cast<const __FlashStringHelper *>("Closing time must be between 0 and 30 seconds"));
  }
  else if (closeTime <= 0 || closeTime > 30)
  {
    page += (reinterpret_cast<const __FlashStringHelper *>("Opening time must between 0 and 30 secondes"));
  }
  else if (maxDropVoltage <= 0 || maxDropVoltage > 600)
  {
    page += (reinterpret_cast<const __FlashStringHelper *>("Maximum drop voltage must between 0 and 600 secondes"));
  }
  else if (maxDetectionTime <= 0 || maxDetectionTime > 50)
  {
    page += (reinterpret_cast<const __FlashStringHelper *>("Maximum detection time must between 0 and 50 secondes"));
  }
  else
  {
    page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_SYSTEM_SUCCESS));
...
void handleMQTT()
{
  ...
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_STYLE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_HEAD_END));
  page += (reinterpret_cast<const __FlashStringHelper *>(MQTT_PAGE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_END));
...
void handleMQTTSave()
{
  ...
  {
    page += (reinterpret_cast<const __FlashStringHelper *>("MQTT host or port cannot be empty"));
    page.replace("{time}", "5");
  }
  else if (mqttEnabled && user == "")
  {
    page += (reinterpret_cast<const __FlashStringHelper *>("MQTT user cannot be empty"));
    page.replace("{time}", "5");
  }
  else if (mqttEnabled && (topic == "" || fullTopic == ""))
  {
    page += (reinterpret_cast<const __FlashStringHelper *>("MQTT topic or fullTopic cannot be empty"));
    page.replace("{time}", "5");
  }
  else
  {
    page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_MQTT_SUCCESS));
...
void handleHUE()
{
  ...
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_STYLE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_HEAD_END));
  page += (reinterpret_cast<const __FlashStringHelper *>(HUE_PAGE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_END));
...
void handleHUESave()
{
  ...
  {
    page += (reinterpret_cast<const __FlashStringHelper *>("Light or lampshade name cannot be empty !"));
    page.replace("{time}", "5");
  }
  else
  {
    page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_HUE_SUCCESS));
...
void handleWifiSave()
{
  ...
  if (server.hasArg("ip"))
  {
    ...
    page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_WIFI_PARAMS_SUCCESS));
    page.replace("{time}", "30");
  }
  ...
  if (server.hasArg("ssid"))
  {
    ...
    {
      page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_WIFI_CONNECT));
    ...
    else
    {
      if (wifiConnect(ssid, pass))
      {
        ...
        page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_WIFI_CONNECT_SUCCESS));
      ...
      else
      {
        ...
        page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_WIFI_CONNECT_FAIL));
...
void handleInfos()
{
  ...
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_STYLE));
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_HEAD_END));
  page += (reinterpret_cast<const __FlashStringHelper *>(INFOS_PAGE));
  ...
  page.replace("{firmware}", "eclipse-v1.30-BETA");
...
# 967 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino"
  }
}
...
void checkOTAUpdate()
{
  ...
  switch (ESPhttpUpdate.update(client, "http://firmwares.domotique-passion.fr/eclipse/"))
  {
...
String getNetworks()
{
  ...
  if (numNetworks == 0)
  {
    page += (reinterpret_cast<const __FlashStringHelper *>(NO_NETWORKS)); // @token nonetworks
    page += "<br/><br/>";
  }
  else
  {
    ...
    String HTTP_ITEM_STR = (reinterpret_cast<const __FlashStringHelper *>(HTTP_ITEM));

    // toggle icons with percentage
    HTTP_ITEM_STR.replace("{qp}", (reinterpret_cast<const __FlashStringHelper *>(HTTP_ITEM_QP)));
    HTTP_ITEM_STR.replace("{qi}", (reinterpret_cast<const __FlashStringHelper *>(HTTP_ITEM_QI)));
  ...
  String pitem = (reinterpret_cast<const __FlashStringHelper *>(HTTP_FORM_WIFI));
  ...
  if (WiFi.isConnected())
  {
    page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_FORM_WIFI_PARAMS));
  ...
  page += (reinterpret_cast<const __FlashStringHelper *>(HTTP_FORM_WIFI_BACK));
...
{
  if (delayedFunction != 
# 1148 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 3 4
                        __null
# 1148 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino"
                            )
  {
    if (millis() - delayedTime >= delayedPeriod)
    {
      (*delayedFunction)();
      delayedFunction = 
# 1153 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino" 3 4
                       __null
# 1153 "c:\\Users\\Utilisateur\\Desktop\\Projet automatisation lampe IKEA\\Programmation\\RemoteController\\RemoteController.ino"
                           ;
      return;
    }
  }
...
void checkStatus()
{
  if (millis() - statusTime >= 1000)
  {
    ...
    lightStatus = (digitalRead(13 /* Revoir l'affectation de la pin*/) == 0x1) ? "on" : "off";
...
void sendCommand(String cmd)
{
  ...
  {
    digitalWrite(13 /* Revoir l'affectation de la pin*/, !digitalRead(13 /* Revoir l'affectation de la pin*/));
  }
  ...
  if (cmd == "on" || cmd == "off" || cmd == "toggle")
  {
    ...
    if (restoreLastState)
    {
      ...
      config["status"]["light"] = digitalRead(13 /* Revoir l'affectation de la pin*/);
      saveConfig();
    }
  }
}
...
void setup()
{
  ...
  pinMode(4, 0x01);
  pinMode(12, 0x01);
  pinMode(13 /* Revoir l'affectation de la pin*/, 0x01);
  pinMode(10, 0x02);
  ...
  if (restoreLastState)
  {
    digitalWrite(13 /* Revoir l'affectation de la pin*/, config["status"]["light"]);
  }
